...
import com.accessed.ecommerce.model.dto.response.pagination.Meta;
import com.accessed.ecommerce.model.dto.response.pagination.PaginationResponse;
import com.accessed.ecommerce.model.dto.response.product.ProductPopular;
import com.accessed.ecommerce.model.entity.*;
...
import com.accessed.ecommerce.model.mapper.ProductMapper;
import com.accessed.ecommerce.model.mapper.ProductVariantMapper;
import com.accessed.ecommerce.model.projection.ProductPopularProjection;
import com.accessed.ecommerce.repository.*;
import com.accessed.ecommerce.service.*;
...
//    }
    ...
    public PaginationResponse getTopProductsSold(int page, int size) {
        ...
        Pageable pageable = PageRequest.of(page, size, sort);
        Page<ProductPopularProjection> productPage = productRepository.findPopularProducts(pageable);
